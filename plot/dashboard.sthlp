...
{* 2018年3月22日}
{hline}
{cmd:help dashboard}{right: }
{hline}

{title:标题}

{phang}
{bf:dashboard} {hline 2} Stata+ECharts绘制仪表盘。{p_end}

{pstd}{browse "https://github.com/czxa/dashboard/raw/master/dashboard.png":示例图片}{p_end}


{title:语法}

{p 8 18 2}
{cmd:dashboard} {bf: arg} {bf: [, {opt ti:tle}(}{it:string}{bf:) {opt html:name}(}{it:string}{bf:)]}
...
{phang}
{stata `"dashboard 15.6, ti(利率) html(仪表盘)"'}
{p_end}
